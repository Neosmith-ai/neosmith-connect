...
Add to your shell profile (see your [platform guide](../README.md#platform-setup-operating-system)):
...
> Full details + per-project override: [agents/claude-code.md](../agents/claude-code.md)
...
> Full details incl. enterprise IDE Services: [agents/jetbrains-ai.md](../agents/jetbrains-ai.md)
...
See [agents/cline.md](../agents/cline.md).
