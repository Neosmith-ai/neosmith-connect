...
Common issues across all IDEs, agents, and platforms. Always start by confirming raw connectivity with [verify-connection.md](verify-connection.md) — this tells you whether the problem is your **key/endpoint** or your **agent config**.
...
1. Run all five checks in [verify-connection.md](verify-connection.md).
