...
This guide covers running NeoSmith on **native Windows** (PowerShell, no WSL). If you prefer a Linux-like environment, see [Windows WSL2](windows-wsl.md) — recommended for most agentic workflows.
...
| Claude Code behaves oddly | Some agent tooling assumes a POSIX shell | Consider [WSL2](windows-wsl.md) |
